...
QUIZ_QUESTIONS = [
    {'q': 'Какая планета самая большая?', 'opts': ['Сатурн', 'Юпитер', 'Нептун', 'Уран'], 'a': 2},
    {'q': 'Сколько планет в Солнечной системе?', 'opts': ['7', '9', '8', '10'], 'a': 3},
    {'q': 'Какая планета ближайшая к Солнцу?', 'opts': ['Венера', 'Земля', 'Марс', 'Меркурий'], 'a': 4},
    {'q': 'Самая высокая гора в Солнечной системе?', 'opts': ['Эверест', 'Олимп', 'Элизий', 'Асида'], 'a': 2},  # Исправлено
    {'q': 'Сколько спутников у Марса?', 'opts': ['0', '1', '2', '4'], 'a': 3},
    {'q': 'Какая планета с самыми известными кольцами?', 'opts': ['Юпитер', 'Уран', 'Нептун', 'Сатурн'], 'a': 4},
    {'q': 'Что такое световой год?', 'opts': ['Единица времени', 'Расстояние за год', 'Масса звезды', 'Яркость звезды'], 'a': 2},
    {'q': 'Наша галактика?', 'opts': ['Андромеда', 'Магелланово облако', 'Млечный Путь', 'Водоворот'], 'a': 3},
    {'q': 'Какая планета вращается "лёжа на боку"?', 'opts': ['Нептун', 'Марс', 'Уран', 'Юпитер'], 'a': 3},  # Исправлено
    {'q': 'Из чего состоит Солнце?', 'opts': ['Гелий и кислород', 'Водород и гелий', 'Азот и водород', 'Кислород и углерод'], 'a': 2},
    {'q': 'Что такое горизонт событий?', 'opts': ['Кольцо пыли', 'Граница невозврата', 'Орбита спутника', 'Слой атмосферы'], 'a': 2},  # Исправлено
    {'q': 'Какой телескоп сфотографировал первую ЧД?', 'opts': ['Хаббл', 'Уэбб', 'EHT', 'Кеплер'], 'a': 3}
]
